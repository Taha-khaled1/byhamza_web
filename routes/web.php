...
Route::get('slideedit' , [SlideController::class , 'edit'])->name('slideedit');

Route::post('slideupdate' , [SlideController::class , 'update'])->name('slideupdate');
Route::post('slidestore' , [SlideController::class , 'store'])->name('slidestore');

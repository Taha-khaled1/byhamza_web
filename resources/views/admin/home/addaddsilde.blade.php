                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">تعديل الشرائح</h4>
                        </div>
                        <!--end page-title-box-->
                    </div>
                    <!--end col-->
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <form  action="{{ route('slideupdate') }}" method="POST" enctype="multipart/form-data">
                                {{ method_field('post') }}
                                {{ csrf_field() }}
                                <input type="text" id="id" name="id" value="{{$images->id}}" hidden>
                                <div class="form-group">
                                    <label for="name">الاسم:</label>
                                    <input type="text" id="name" name="name" class="form-control" value="{{$images->name}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="old-image">الصوره :</label>
                                        <div>
                                            <img src="{{asset($images->image)}}" alt="Old Image" class="image-preview">
                                        </div>
                                    </div>
                                </div>
